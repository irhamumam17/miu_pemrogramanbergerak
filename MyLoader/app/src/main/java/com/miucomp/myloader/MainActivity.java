...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, AdapterView.OnItemClickListener {
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        if (id==CONTACT_LOAD){
            ...
            mCursorLoader = new CursorLoader(MainActivity.this, ContactsContract.CommonDataKinds.Phone.CONTENT_URI,phoneProjectionFields, ContactsContract.CommonDataKinds.Phone.CONTACT_ID + " = ? AND "+
        ...
        if (requestCode == CONTACT_REQUEST_CODE){
            if (grantResults.length>0){
                if (grantResults[0]== PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(this, "Contact Permission Rejected", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            if (grantResults.length>0){
                if (grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(this, "Call Permission Rejected", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
